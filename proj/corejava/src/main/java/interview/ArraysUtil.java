...
public class ArraysUtil
{
    ...
    /**
     * This method keeps even numbers in even possition and odd numbers in odd possition
     * Extra even or odd numbers keeps as it is
     * @param a array name
     ...
     * @param a array name
     * @param d number of rigth rotations
     * @param n size of array
     */
     ...
     * @param a name of the array
     * @param separator separator for each element.
     */
     ...
     * @param a name of the array
     * @param d number of elements to rotate right
     * @param n size of array
     */
     ...
     * @param a name of the array
     * @param d number of elements to rotate left
     * @param n size of array
     */
